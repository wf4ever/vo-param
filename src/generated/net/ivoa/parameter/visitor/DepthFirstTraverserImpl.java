    ...
    implements Traverser
{
    ...
    public void traverse(ClientServerCommunication aBean, Visitor aVisitor) {
        if (aBean.getUser()!= null) {
            aBean.getUser().accept(aVisitor);
        }
        for (PDLService bean: aBean.getPDLServices()) {
            bean.accept(aVisitor);
        }
    }
    ...
    public void traverse(Job aBean, Visitor aVisitor) {
        ...
        for (Result bean: aBean.getResults()) {
            bean.accept(aVisitor);
        }
        for (Error bean: aBean.getErrors()) {
            bean.accept(aVisitor);
        }
    }
