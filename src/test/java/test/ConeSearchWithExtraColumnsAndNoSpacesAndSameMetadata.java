...
public class ConeSearchWithExtraColumnsAndNoSpacesAndSameMetadata extends BaseExample {

	public static void main(String[] args) throws PropertyException,
			FileNotFoundException, JAXBException {
		ConeSearchWithExtraColumnsAndNoSpacesAndSameMetadata example = new ConeSearchWithExtraColumnsAndNoSpacesAndSameMetadata();
		example.marshall();
	}
	...
	protected Service buildService() {
		...
		RA.setName("RA");
		RA.setSkossConcept("Right ascension J2000");
		...
		DEC.setName("DEC");
		DEC.setSkossConcept("Declination J2000");
		...
		DEC_J2000.setSkossConcept("Declination J2000");
