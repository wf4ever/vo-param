...
\end{center}
\end{figure}
The Criterion contained into a {\it Always} object must always be valid (cf paragraph
...
It is a bit more complex when criteria contains {\it LogicalConnectors}. Let us see how to
proceed.\\
